...
<head>
  ...
  <meta charset="utf-8" />
  <title>Sign In | CV. Makmur Permata</title>
                    ...
                    <div class="position-relative h-100 d-flex flex-column">
                      <div class="mb-4">
                        <a href="index.html" class="d-block">
                          <h3 style="color:white">CV. MAKMUR PERMATA</h3>
                        </a>
                      </div>
                      <div class="mt-auto">
                        <div class="mb-3">
                        ...
                        <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                          ...
                          <div class="carousel-inner text-center text-white-50 pb-5">
                            <div class="carousel-item active">
                              <p class="fs-15 fst-italic">"Bangkit, Karena menyerah bukan pilihan"</p>
                            </div>
                            <div class="carousel-item">
                              <p class="fs-15 fst-italic">"Kejujuran dalam bekerja hal yang paling utama"</p>
                            </div>
                          </div>
                        </div>
                        <!-- end carousel -->
                ...
                <div class="col-lg-6">
                  <div class="p-lg-5 p-4">
                    <div>
                      ...
                      <p class="text-muted">Sign in to continue to Presence App.</p>
                    </div>
                      ...
                      <form action="<?php echo base_url();?>auth/login" method="post" autocomplete="off">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="position-relative auth-pass-inputgroup mb-3">
                            <input type="password" class="form-control pe-5" placeholder="Enter password" name="password">
                          </div>
                        </div>
