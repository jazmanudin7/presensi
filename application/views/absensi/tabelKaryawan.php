                ...
                <tbody>
                    ...
                    <tr style="color:black">
                        ...
                        <td align="right" width="50px">
                            <a href="#" data-nik="<?php echo $d->nik; ?>" data-nama="<?php echo $d->nama_karyawan; ?>"  data-dept="<?php echo $d->departemen; ?>" class="btn btn-sm btn-warning pilih"><i class="fa fa-check"></i></a>
                        </td>
                    </tr>
                  <?php } ?>
                </tbody>
