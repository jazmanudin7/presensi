<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <a href="<?php echo base_url(); ?>sp/inputSp" class="btn btn-xs btn-primary">Tambah Data</a>
        <h5 class="card-title" align="center">DATA SP KARYAWAN</h5>
              ...
              foreach ($data->result() as $d) { ?>
                <tr>
                  ...
                  <td align="right" width="100px">
                    <a href="<?php echo base_url(); ?>sp/editSp/<?php echo $d->kode_sp; ?>" class="btn btn-sm btn-warning"><i class="ri-pencil-fill"></i></a>
                    <a href="#" data-href="<?php echo base_url(); ?>sp/hapusSp/<?php echo $d->kode_sp; ?>" class="delete btn btn-sm btn-danger"><i class="ri-delete-bin-6-line"></i></a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
