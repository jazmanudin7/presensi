<form id="form" method="POST" autocomplete="off" enctype="multipart/form-data" action="<?php echo base_url(); ?>catatan/updateCatatan">

  <div class="col-lg-6">
    <div class="card">
      <div class="card-body">
        <div class="card-title">Input Data Catatan</div>
        <hr>
        <div class="form-group">
          <label for="input-1">NIK</label>
          <input type="hidden" value="<?php echo $data['kode_catatan'];?>" name="kode_catatan" id="kode_catatan" required class="form-control" placeholder="Kode Catatan">
