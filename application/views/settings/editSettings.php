<form id="form" method="POST" autocomplete="off" enctype="multipart/form-data" action="<?php echo base_url(); ?>Settings/updateSettings">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="hidden" value="<?php echo $data['id']; ?>" name="id" id="id" required class="form-control" placeholder="id">
        ...
        <div class="form-group">
          ...
          <input type="text" value="<?php echo $data['jumlahHari']; ?>" name="jumlahHari" id="jumlahHari" required class="form-control" placeholder="Jumlah Hari">
        </div>
        <div class="form-group">
          <label for="input-1">Jumlah Jam</label>
          <input type="text" value="<?php echo $data['jumlahJam']; ?>" name="jumlahJam" id="jumlahJam" required class="form-control" placeholder="Jumlah Jam">
        </div>
        <div class="form-group">
          <label for="input-1">Premi Shift 2</label>
          <input type="text" value="<?php echo $data['premi2']; ?>" style="text-align: right" name="premi2" id="premi2" required class="form-control" placeholder="Premi Shift 2">
        </div>
        <div class="form-group">
          <label for="input-1">Premi Shift 3</label>
          <input type="text" value="<?php echo $data['premi3']; ?>" style="text-align: right" name="premi3" id="premi3" required class="form-control" placeholder="Premi Shift 3">
        </div>
