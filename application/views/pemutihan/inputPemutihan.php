<form id="form" method="POST" autocomplete="off" enctype="multipart/form-data" action="<?php echo base_url(); ?>Pemutihan/insertPemutihan">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" style="text-align:right" name="nominal" id="nominal" required class="form-control" placeholder="Nominal">
        </div>
        <div class="form-group">
