...
<div class="card-body" style="zoom:100%">
    ...
    $catatan    = $this->db->query("SELECT * FROM catatan INNER JOIN karyawan ON karyawan.nik = catatan.nik WHERE catatan.tanggal BETWEEN '$dari' AND '$sampai' AND karyawan.departemen = '$departemen' AND karyawan.kantor = '$kantor' ORDER BY catatan.tanggal DESC")->result();
    foreach ($catatan as $c) { ?>
        <ul>
            <li><b><?php echo $c->nama_karyawan; ?> - <?php echo tgl_indo($c->tanggal); ?> : </b><?php echo $c->keterangan; ?></li>
        </ul>
    <?php } ?>
