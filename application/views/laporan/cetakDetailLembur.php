                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="color:black">
                                ...
                                <td align="center"><?php echo $d->jmDuaenam. " - " .$d->jpDuaenam; ?></td>
                                <td align="center"><?php echo $d->jmDuatujuh. " - " .$d->jpDuatujuh; ?></td>
                                <td align="center"><?php echo $d->jmDuadelapan. " - " .$d->jpDuadelapan; ?></td>
                                
                                <?php if ($jumlahhariini >= '29') { ?>
                                    <td align="center"><?php echo $d->jmDuasembilan. " - " .$d->jpDuasembilan; ?></td>
                                <?php } ?>
                                <?php if ($jumlahhariini >= '30') { ?>
                                    <td align="center"><?php echo $d->jmTigapuluh. " - " .$d->jpTigapuluh; ?></td>
                                <?php } ?>
                                <?php if ($jumlahhariini >= '31') { ?>
                                    <td align="center"><?php echo $d->jmTigasatu. " - " .$d->jpTigasatu; ?></td>
                                <?php } ?>
                                <td align="center"><?php echo $d->jmSatu. " - " .$d->jpSatu; ?></td>
                                <td align="center"><?php echo $d->jmDua. " - " .$d->jpDua; ?></td>
                                <td align="center"><?php echo $d->jmTiga. " - " .$d->jpTiga; ?></td>
                                <td align="center"><?php echo $d->jmEmpat. " - " .$d->jpEmpat; ?></td>
                                <td align="center"><?php echo $d->jmLima. " - " .$d->jpLima; ?></td>
                                <td align="center"><?php echo $d->jmEnam. " - " .$d->jpEnam; ?></td>
                                <td align="center"><?php echo $d->jmTujuh. " - " .$d->jpTujuh; ?></td>
                                <td align="center"><?php echo $d->jmDelapan. " - " .$d->jpDelapan; ?></td>
                                <td align="center"><?php echo $d->jmSembilan. " - " .$d->jpSembilan; ?></td>
                                <td align="center"><?php echo $d->jmSepuluh. " - " .$d->jpSepuluh; ?></td>
                                <td align="center"><?php echo $d->jmSebelas. " - " .$d->jpSebelas; ?></td>
                                <td align="center"><?php echo $d->jmDuabelas. " - " .$d->jpDuabelas; ?></td>
                                <td align="center"><?php echo $d->jmTigabelas. " - " .$d->jpTigabelas; ?></td>
                                <td align="center"><?php echo $d->jmEmpatbelas. " - " .$d->jpEmpatbelas; ?></td>
                                <td align="center"><?php echo $d->jmLimabelas. " - " .$d->jpLimabelas; ?></td>
                                <td align="center"><?php echo $d->jmEnambelas. " - " .$d->jpEnambelas; ?></td>
                                <td align="center"><?php echo $d->jmTujuhbelas. " - " .$d->jpTujuhbelas; ?></td>
                                <td align="center"><?php echo $d->jmDelapanbelas. " - " .$d->jpDelapanbelas; ?></td>
                                <td align="center"><?php echo $d->jmSembilanbelas. " - " .$d->jpSembilanbelas; ?></td>
                                <td align="center"><?php echo $d->jmDuapuluh. " - " .$d->jpDuapuluh; ?></td>
                                <td align="center"><?php echo $d->jmDuasatu. " - " .$d->jpDuasatu; ?></td>
                                <td align="center"><?php echo $d->jmDuadua. " - " .$d->jpDuadua; ?></td>
                                <td align="center"><?php echo $d->jmDuatiga. " - " .$d->jpDuatiga; ?></td>
                                <td align="center"><?php echo $d->jmDuaempat. " - " .$d->jpDuaempat; ?></td>
                                <td align="center"><?php echo $d->jmDualima. " - " .$d->jpDualima; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
