<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title" align="center">LAPORAN ABSENSI LEMBUR</h5>
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporan/cetakAbsensiLembur" target="_blank">
                    ...
                    <div class="mb-3">
                        <select class="form-control select2" id="kantor" name="kantor">
                            ...
                            <?php foreach ($kantor->result() as $g) { ?>
                                <option value="<?php echo $g->kantor;?>"><?php echo $g->kantor;?></option>
                            <?php } ?>
                        </select>
                    </div>
